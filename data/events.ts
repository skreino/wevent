...
const instagramBySlug: Record<string, string> = {
  'neon-basement': 'tunnelclubmilano',
  'cortile-live': 'mareculturaleurbano',
  'standup-mi': 'santeria.milano',
  'secret-show': 'arcibellezza'
}
...
export const events: Event[] = [
  ...
  ['market-bites', 'Market Bites', 'Piazza Vecchia', 'Bergamo', 'Piazza Vecchia', 45.704, 9.662, 'food', 7, '12:00', 'free', undefined, false, false, 'Assaggi, banchetti, cose buone da mangiare in piedi. Zero formalità.', 'photo-1555939594-58d7cb561ad1'],
  ...
  instagramUrl: instagramBySlug[String(slug)],
  tags: [category as string, city as string]
})) as Event[]
